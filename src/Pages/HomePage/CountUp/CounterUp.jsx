        ...
        <div className="w-9/12 mx-auto">
            <div data-aos="fade-up"
             ...
             className="text-center space-y-5 mt-20 my-16">
                <h3 className="text-blue-700 text-xl font-extrabold">THE FACTS</h3>
                <h1 className="text-xl md:text-5xl text-zinc-950 font-semibold">Managing Your Business in Todays Modern <br /> Environment is <span className="text-blue-700 font-extrabold">More Complex Than Ever</span></h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
                    ...
                    className="text-center space-y-2  ">
                        ...
                        <h4 className="text-md  text-gray-600 font-normal py-8">in 2022 with this number expected to <br /> grow year over year 1.</h4>
                    </div>
                    ...
                    className="text-center space-y-2 md:border-r-2 border-blue-400 md:border-l-2  ">
                        ...
                        <h4 className="text-md  text-gray-600 font-normal py-8">worldwide in 2024 due to a <br /> combination of cloud vendor price <br /> increase and increased utilization</h4>
                    </div>
                    ...
                    className="text-center space-y-2  ">
                        ...
                        <h4 className="text-md  text-gray-600 font-normal py-8">of organizations admitting they do not <br /> have a reliable source to keep training <br /> up to date</h4>
                    </div>
